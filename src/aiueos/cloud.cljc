(ns aiueos.cloud
  ...
  mechanism, exactly as in `aiueos.ota`.
...
(defn admit-block
  ...
  received, because this namespace does not hash (`aiueos.signing/sha256-hex`
...
(defn perform
  "Run an allowed PLAN's request through `aiueos.net/guarded-fetch`, so the URL
