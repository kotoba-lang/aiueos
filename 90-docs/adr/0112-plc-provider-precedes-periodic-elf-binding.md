...
- Status: superseded as C-free evidence
- Date: 2026-08-26
...
The 2026-08-26 closure is retracted for the C-free claim. Commits 428ab44,
673438f, 48ba35c and d639653 exercised a C-compiled kernel scheduler, loader and
provider around Kotoba-generated objects. Their QEMU marker is valid only as
hybrid functional evidence.

The replacement C-free slice is tracked by ADR-0110 and
native/rt-kernel.kotoba. It moves the APIC/IDT setup, fixed-priority selection
and PLC scan loop into Kotoba and is generated by Amu. It does not yet
reproduce this ADR's general CPL3 signed-ELF transaction provider; that work
remains open and must obtain a new marker rather than inherit the hybrid one.
