...
### Kotoba guests: ten kernel-adjacent namespaces (ADR-0202)
- `aiueos/topic.kotoba`, `aiueos/os_update.kotoba`,
  ...
  `aiueos/bare_metal.kotoba` and `aiueos/virtio.kotoba` compile as pure
  Kotoba guests
...
- None of the ten declares or calls a capability: effect inference
