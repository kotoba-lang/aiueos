...
### Kotoba guests: nine kernel-adjacent namespaces (ADR-0202)
- `aiueos/topic.kotoba`, `aiueos/os_update.kotoba`,
  ...
  `aiueos/bare_metal.kotoba` compile as pure Kotoba guests
...
- None of the nine declares or calls a capability: effect inference
