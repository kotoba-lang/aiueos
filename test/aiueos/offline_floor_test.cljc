(ns aiueos.offline-floor-test
  ...
  Each piece is individually covered elsewhere: `aiueos.enroll-test`,
...
(deftest admission-still-decides-and-still-refuses
  ...
  (testing "an untrusted one is denied with the uplink down, which is the
            ...
            permissive one"
    ;; The same manifest aiueos.broker-test denies: an AI-generated component
