...
This repository keeps GitHub issue source material in-repo so aiueos security
findings can be reviewed, versioned, and synchronized.
...
```sh
gh issue edit <number> --repo kotoba-lang/aiueos \
