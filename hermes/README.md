...
| profile | description |
|---|---|
| `aiueos-cfree` | aiueos kernel C-free programme (ADR-0220): 1 step per tick, monitor-gated |
| `aiueos-handoff` | AIUEOS K16 pure-Kotoba handoff (ADR-2609031030): gate N1-N6 progression, |
| `linux-parity` |  |
